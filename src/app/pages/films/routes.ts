...
import {DUBBING_ID_ROUTE_PARAM, RESOLVE_DUBBING_KEY, resolveDubbing} from './[id]/edit/dubbing/dubbing.resolver';
            ...
            children: [
              {
                ...
                loadComponent: () => import('./[id]/edit/dubbing/dubbing-page.component').then(m => m.DubbingPageComponent)
              }
            ]
          }
        ]
